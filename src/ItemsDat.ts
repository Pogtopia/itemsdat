    ...
    return new Promise(
      async (resolve) => {
        ...
        for (const item of meta.items) {
          ...
          this.data.writeInt16LE(item.flags, this.mempos)
          this.mempos += 2;
          ...
          if (typeof extraBytesObj=== 'object' &&
            extraBytesObj?.type === 'Buffer')
          ...
          if (meta.version >= 11) {
            ...
            if (meta.version >= 12) {
              ...
              if (typeof bodyPartObj === 'object' &&
                bodyPartObj?.type === 'Buffer')
